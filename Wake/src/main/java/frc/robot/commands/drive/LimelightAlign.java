...
public class LimelightAlign extends CommandBase {
  ...
  PIDController limelightAnglePID = new PIDController(0.0, 0.0, 0.0);
  ...
  public void execute() {
    ...
    limelightAnglePID.setPID(angle_kP, angle_kI, angle_kD);
    val = limelightAnglePID.calculate(input, setpoint);
