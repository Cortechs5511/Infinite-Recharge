...
public class TowerSimpleForward extends SequentialCommandGroup {
	@SuppressWarnings({ "PMD.UnusedPrivateField", "PMD.SingularField" })
	public TowerSimpleForward(double startDelay, Shooter shooter, Feeder feeder, Limelight limelight, Drive drive, Intake intake) {
		addCommands(
