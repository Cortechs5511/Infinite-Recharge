...
public class TowerSimplePath extends CommandBase {
  ...
  public void initialize() {
    ...
    leftTarget = ((points[1][3] * TICKS_PER_FOOT - leftReference) * 0.6) + leftReference;
    rightTarget = ((points[1][11] * TICKS_PER_FOOT - rightReference) * 0.6) + rightReference;
  }
  ...
  public void execute() {
    if ((m_drive.getLeftPosition.get() > leftTarget) && (m_drive.getRightPosition.get() > rightTarget)) {
      ...
      leftTarget = ((points[row + 1][3]* TICKS_PER_FOOT - leftReference) * 0.6) + leftReference;
      rightTarget = ((points[row + 1][11]* TICKS_PER_FOOT - rightReference) * 0.6) + rightReference;
